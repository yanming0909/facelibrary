...
import static com.idl.stub.GlobalSet.FEATURE_SIZE;
...
public class FaceSDKManager {
    ...
    public void init(final Context context, final SdkInitListener listener){
        ...
        init(context,listener,licenseOfflineKey,licenseOnlineKey);
    }
     ...
     * @param listener
     */
    public void init(final Context context, final SdkInitListener listener, final String licenseOfflineKey, final String licenseOnlineKey) {
            ...
            faceAuth.initLicenseOffLine(context, new Callback() {
                ...
                public void onResponse(int code, String response) {
                    if (code == 0) {
                        ...
                        //更新sp
                        PreferencesUtil.putString("activate_offline_key",licenseOfflineKey);
